function[struct_theta,struct_ALPHA,struct_beta1,struct_beta2,A,B,C,D,E]=TF_LME_fixation(subject,behavior_path,EEG_path)
...
[~,~,f,alpha,pwe,congruency,EEG,~,~,~,~,~,~]=EEG_aligh_behavior(f,alpha,congruency,uncertainty,EEG,EEGdel,del_list,0);
...
cfg.output = 'pow';
cfg.foi = 3:0.5:30;
cfg.toi = [-0.64:0.002:-0.36,1:0.002:2.7];
cfg.width = 3;
cfg.keeptrials  = 'yes';
